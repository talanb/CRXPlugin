...
public class CrxRepository {
    ...
    public CrxRepository(String url, String user, String password) {
        this.url = url;
        this.user = user;
        this.password = password;
         this.session = findRepository(url, user, password);
    }
    ...
    private Session findRepository(String url, String user, String password) {
        dumpClassPath(this);
